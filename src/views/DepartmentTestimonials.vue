...
<template>
  <h1 class="text-3xl font-bold mb-4 text-blue-700">Billing Department's Testimonials</h1>
  <p class="mb-6 text-gray-600">
    This is where all team members' accomplishments are posted as motivation throughout the
    department.
  </p>
              ...
              >
                ...
                <div>
                  ...
                  <ul class="list-disc list-inside text-gray-700 space-y-2">
                    <li v-for="(step, i) in wf.steps" :key="i">{{ step }}</li>
                  </ul>
                </div>
