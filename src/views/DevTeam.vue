...
<template>
  <section class="max-w-5xl mx-auto p-8 bg-blue-100 shadow-sm rounded-lg mt-2">
    <div class="mx-auto max-w-7xl px-4 sm:px-6 lg:px-8">
      ...
      <div class="flex flex-wrap justify-center gap-y-14 max-w-3xl mx-auto lg:max-w-full">
        <div class="group block text-center lg:w-1/5 sm:w-1/3 min-[450px]:w-1/2 w-full">
          ...
          <h4
            class="text-xl text-gray-900 font-semibold text-center mb-2 transition-all duration-500 group-hover:text-indigo-600"
          >
            Philomathes
          </h4>
          <span
            class="text-gray-500 text-center block transition-all duration-500 group-hover:text-gray-900"
            >Founder</span
          >
        </div>
        <div class="group block text-center lg:w-1/5 sm:w-1/3 min-[450px]:w-1/2 w-full">
