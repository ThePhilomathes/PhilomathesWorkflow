      ...
      >
        <div class="w-full lg:w-2/5">
          ...
          <h2 class="text-4xl font-bold text-gray-900 leading-[3.25rem] mb-8">
            ...
            <span
              class="text-transparent bg-clip-text bg-gradient-to-tr from-indigo-600 to-violet-600"
              >Feedback</span
            >
          </h2>
          <!-- Slider controls -->
            ...
            <div class="swiper-wrapper">
              ...
              >
                <div class="flex items-center gap-5 mb-5 sm:mb-9">
                  ...
                  />
                  <div class="grid gap-1">
                    <h5 class="text-gray-900 font-medium transition-all duration-500">Harsh P.</h5>
                ...
                <p
                  class="text-sm text-gray-500 leading-6 transition-all duration-500 min-h-24 group-hover:text-gray-800"
                >
                  I used to dread doing my taxes every year, but pagedone has made the process so
